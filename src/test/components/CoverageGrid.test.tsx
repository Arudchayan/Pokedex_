...
const mockMoves = [
    { id: 1, name: 'scratch', type: 'normal', category: 'physical', power: 40, accuracy: 100, pp: 35 },
    { id: 2, name: 'ember', type: 'fire', category: 'special', power: 40, accuracy: 100, pp: 25 },
    { id: 3, name: 'water-gun', type: 'water', category: 'special', power: 40, accuracy: 100, pp: 25 },
];
