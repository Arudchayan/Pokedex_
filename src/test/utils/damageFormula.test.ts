...
describe('Damage Formula Logic', () => {
    ...
    describe('Ability Logic', () => {
        const createPokemon = (name: string, types: string[], ability: string = 'None', stats: any = {}) => ({
            name,
            level: 50,
            types,
            stats: [
        ...
        const createMove = (name: string, type: string, power: number, damageClass: 'physical' | 'special' = 'physical') => ({
            name,
            power,
            type,
            damageClass
