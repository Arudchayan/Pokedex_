  ...
  return (
    ...
    >
      ...
      <div className="absolute right-2 top-2 flex gap-1 z-10">
        <button
          ...
          className={`p-1 rounded-md transition focus:outline-none focus:ring-2 focus:ring-primary-500 ${
            theme === 'dark'
              ? 'text-slate-400 hover:text-primary-300 hover:bg-white/10'
              : 'text-slate-400 hover:text-primary-600 hover:bg-slate-200'
          }`}
      ...
      >
        ...
        <div>
          <p
            className={`text-sm font-semibold capitalize ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}
          >
            {member.name}
          </p>
