    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Export Team" size="md">
        ...
        {activeTab === 'export' ? (
            <div className="space-y-4">
                <p id="export-modal-desc" className="text-sm text-slate-400">Copy this text to share your team or use it in Pokemon Showdown.</p>
                <textarea
                    readOnly
                    value={exportText}
            ...
            <div className="space-y-4">
                <p id="export-modal-desc" className="text-sm text-slate-400">Paste a team (Showdown format) here to load it.</p>
                <textarea
                    value={importText}
