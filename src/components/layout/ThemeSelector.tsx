...
const DIGITAL_COLORS: AccentColor[] = [
  'neonPink',
  'neonCyan',
  'neonYellow',
  'neonGreen',
  ...
  if (!isCyberpunk) {
    return (
      <div className="relative" ref={dropdownRef}>
        ...
        {isOpen && (
          <div
            className={`absolute top-full mt-2 right-0 w-64 rounded-xl shadow-2xl border p-4 z-50 flex flex-col gap-4 origin-top-right transition-all duration-200 ease-out transform scale-100 opacity-100 ${
          ...
          >
            ...
            <div>
              <h3
                className={`text-xs font-bold uppercase tracking-wider mb-2 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'}`}
              >
                Display Mode
              </h3>
            ...
            <div>
              ...
              {/* Tab switcher */}
              <div
                className={`flex rounded-lg overflow-hidden border mb-3 ${theme === 'dark' ? 'border-white/10 bg-black/20' : 'border-slate-200 bg-slate-50'}`}
              >
                <button
                  ...
                  return (
                    <button
                      ...
                      className={`group relative h-10 rounded-lg border transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                        theme === 'dark'
                          ? 'focus:ring-offset-slate-900 border-white/10'
                          : 'focus:ring-offset-white border-black/5'
              ...
              {activeTab === 'digital' && (
                <p
                  className={`text-[10px] mt-2 ${theme === 'dark' ? 'text-slate-500' : 'text-slate-400'}`}
                >
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span
          className="hidden sm:inline text-xs font-black uppercase tracking-[0.15em] text-primary-400"
      ...
      {isOpen && (
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(0, 0, 0, 0.95) 0%, rgba(20, 5, 40, 0.95) 50%, rgba(0, 0, 0, 0.95) 100%)',
        ...
        >
          ...
          <div className="relative px-4 py-3 border-b border-primary-500/30 bg-black/50">
            <div className="flex items-center gap-3">
              ...
              <h2
                className="text-sm font-black uppercase tracking-[0.2em] text-primary-400"
                  ...
                  return (
                    <button
                      ...
                      className={`group relative h-14 rounded-lg transition-all duration-300 flex flex-col items-center justify-center gap-1 hover:scale-110 focus:outline-none ${
                        isSelected
                          ? 'ring-2 ring-white/50 ring-offset-2 ring-offset-black/80 scale-105'
                          : ''
                      }`}
                      style={{
