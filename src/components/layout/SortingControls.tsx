  ...
  return (
    <div className="flex flex-wrap gap-3 items-center">
      <div className="flex items-center gap-2" role="group" aria-labelledby="sort-label">
        <label id="sort-label" className={`text-sm font-semibold ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>Sort by:</label>
        <div className="flex gap-2 flex-wrap">
          ...
          <div className="relative">
            ...
            >
              <option value="" disabled className={theme === 'dark' ? 'bg-slate-800' : 'bg-white'}>Stats...</option>
            ...
            <div className={`pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 ${isStatSelected ? 'text-primary-300' : (theme === 'dark' ? 'text-slate-400' : 'text-slate-500')}`}>
