...
export default function CommandPalette({ isOpen, onClose, controller }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = useMemo(
    () => [
      ...
      {
        id: 'walkers',
        label: 'Pokemon Walkers',
        category: 'Data',
        action: () => {
          modalStore.openWalkersSettings();
          onClose();
        },
        icon: <UserIcon />,
      },
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className={twMerge(
              'text-xs px-2 py-1 rounded border font-mono hidden sm:block',
              theme === 'dark'
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div
                      className={twMerge(
                        'text-xs opacity-60',
                        index === selectedIndex ? 'text-primary-400' : 'text-slate-500'
                      )}
                    >
                      {command.category}
                    </div>
        ...
        >
          ...
          {isCyberpunk && (
            <span className="cyber-text-pink text-[10px] tracking-widest uppercase">
              System Ready
            </span>
          )}
        </div>
