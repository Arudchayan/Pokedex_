    ...
    >
      ...
      <div className="flex-1 min-w-0 grid grid-cols-12 gap-4 items-center">
        ...
        <div className="col-span-4 sm:col-span-3">
          ...
          <h3
            className={`font-bold capitalize truncate ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}
          >
            {pokemon.name}
          </h3>
        </div>
          ...
          <div className="flex flex-col gap-1 w-full">
            {pokemon.stats?.slice(0, 3).map((stat) => (
              <div key={stat.name} className="flex items-center gap-2 text-[10px]">
                <span
                  className={`w-8 uppercase ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'}`}
                >
                ...
                <div
                  className={`h-1 flex-1 rounded-full ${theme === 'dark' ? 'bg-white/10' : 'bg-slate-200'}`}
                >
                  <div
