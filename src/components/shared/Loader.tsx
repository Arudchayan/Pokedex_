...
const Loader: React.FC<LoaderProps> = ({ size = 'h-16 w-16', message, label = 'Loading...' }) => {
  return (
    ...
    >
      ...
      <div className="relative">
        <div className={`${size} relative`}>
          <svg viewBox="0 0 100 100" className="w-full h-full animate-spin-slow" aria-hidden="true">
            ...
            <path d="M 50 5 A 45 45 0 0 1 95 50 L 50 50 Z" className="fill-red-500" />
            <path d="M 50 5 A 45 45 0 0 0 5 50 L 50 50 Z" className="fill-red-500" />
            ...
            <circle
              ...
              cy="50"
              r="15"
              className="fill-slate-50 dark:fill-slate-200 stroke-slate-800 dark:stroke-slate-300"
              strokeWidth="3"
            />
            {/* Center circle - inner */}
      ...
      {!message && <span className="sr-only">{label}</span>}
    </div>
  );
};
