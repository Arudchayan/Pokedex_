        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card variant="elevated">
            ...
            <p className="text-slate-300">
              Default variant with shadow and backdrop blur
            </p>
          </Card>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-slate-300">
              Try hovering or pressing Enter/Space when focused
            </p>
          </Card>
        </div>
      </section>
          ...
          <Card variant="elevated" padding="lg">
            ...
            <Card.Body>
              ...
              <div className="flex gap-2">
                <Badge variant="solid" color="#F8D030">Electric</Badge>
              </div>
            </Card.Body>
  ...
  return (
    <div className="space-y-8 p-8">
        ...
        <div className="space-y-3">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="solid" color="#F08030">Fire</Badge>
              <Badge variant="solid" color="#6890F0">Water</Badge>
              <Badge variant="solid" color="#78C850">Grass</Badge>
              <Badge variant="solid" color="#F8D030">Electric</Badge>
              <Badge variant="solid" color="#F85888">Psychic</Badge>
              <Badge variant="solid" color="#705898">Ghost</Badge>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="soft" color="#F08030">Fire</Badge>
              <Badge variant="soft" color="#6890F0">Water</Badge>
              <Badge variant="soft" color="#78C850">Grass</Badge>
              <Badge variant="soft" color="#F8D030">Electric</Badge>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="outline" color="#F08030">Fire</Badge>
              <Badge variant="outline" color="#6890F0">Water</Badge>
              <Badge variant="outline" color="#78C850">Grass</Badge>
              <Badge variant="outline" color="#F8D030">Electric</Badge>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          <Badge variant="solid" color="#10b981" size="sm">Active</Badge>
          <Badge variant="soft" color="#f59e0b" size="sm">Pending</Badge>
          <Badge variant="outline" color="#ef4444" size="sm">Inactive</Badge>
          <Badge variant="solid" color="#8b5cf6" size="sm">Legendary</Badge>
          <Badge variant="soft" color="#3b82f6" size="sm">New</Badge>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {filters.length === 0 && (
            <p className="text-slate-400 text-sm">No active filters</p>
          )}
        </div>
        {filters.length > 0 && (
          <button
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          <div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <Badge variant="soft" color="#f59e0b" size="sm">BST 534</Badge>
              </div>
              <Badge variant="solid" color="#8b5cf6" size="sm">Legendary</Badge>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Badge variant="solid" color="#F08030">Fire</Badge>
              <Badge variant="solid" color="#A890F0">Flying</Badge>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="outline" size="sm">6/6 Pokemon</Badge>
              <Badge variant="soft" color="#10b981" size="sm">Good Coverage</Badge>
              <Badge variant="soft" color="#f59e0b" size="sm">3 Weaknesses</Badge>
            </div>
          </div>
        </div>
      </section>
