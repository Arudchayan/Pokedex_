...
const ItemGame: React.FC<Props> = ({ onClose, date, seed }) => {
    ...
    if (isLoading || !target) return <div className={`text-center p-8 ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>Loading ItemDle...</div>;
    ...
    return (
        <div className={`flex flex-col h-full w-full items-center ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>
            <div className="flex justify-between items-center mb-6 w-full">
                ...
                <h2 className="text-2xl font-black uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">ItemDle</h2>
