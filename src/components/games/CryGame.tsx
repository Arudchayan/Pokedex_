  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6 w-full">
        ...
        <h2 className="text-2xl font-black uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">
          CryDle
        </h2>
      ...
      <div className="flex-1 w-full max-w-lg flex flex-col items-center justify-center">
        ...
        <p className="mb-8 opacity-70 font-bold">
          {isPlaying ? 'Playing...' : 'Tap to play sound'}
        </p>
