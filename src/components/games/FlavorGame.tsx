  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6 w-full">
        ...
        <h2 className="text-2xl font-black uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500">
          FlavorDle
        </h2>
      ...
      <div className="flex-1 w-full max-w-lg flex flex-col items-center">
        <div
          className={`p-8 rounded-2xl text-center text-xl font-serif italic mb-8 relative ${theme === 'dark' ? 'bg-white/10' : 'bg-slate-100'}`}
        >
