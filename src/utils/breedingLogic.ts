...
export const calculateBreedingCompatibility = (
  ...
  if (groupA.includes('no-eggs') || groupA.includes('undiscovered')) {
    return {
      ...
      offspringId: null,
      offspringName: null,
      message: `${pA.name} cannot breed (Undiscovered Group).`,
    };
  }
  if (groupB.includes('no-eggs') || groupB.includes('undiscovered')) {
    return {
      ...
      offspringId: null,
      offspringName: null,
      message: `${pB.name} cannot breed (Undiscovered Group).`,
    };
  }
  ...
  if (isDittoA && isDittoB) {
    return {
      ...
      offspringId: null,
      offspringName: null,
      message: 'Two Dittos cannot breed.',
    };
  }
  ...
  if (!shareGroup) {
    return {
      ...
      offspringId: null,
      offspringName: null,
      message: 'Incompatible Egg Groups.',
    };
  }
  ...
  if (parentA.gender === 'genderless' || parentB.gender === 'genderless') {
    return {
      ...
      offspringId: null,
      offspringName: null,
      message: 'Genderless Pokemon can only breed with Ditto.',
    };
  }
  ...
  if (parentA.gender === parentB.gender) {
    return {
      ...
      offspringId: null,
      offspringName: null,
      message: 'Parents must be opposite genders.',
    };
  }
