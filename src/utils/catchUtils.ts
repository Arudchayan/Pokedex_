export const BALL_TYPES = {
  ...
  NET_BALL: { name: 'Net Ball', multiplier: 3.5, condition: 'Water or Bug type', color: 'text-teal-500' },
  DUSK_BALL: { name: 'Dusk Ball', multiplier: 3.0, condition: 'Night or Cave', color: 'text-green-600' },
  QUICK_BALL: { name: 'Quick Ball', multiplier: 5.0, condition: 'First Turn', color: 'text-yellow-400' },
  TIMER_BALL: { name: 'Timer Ball', multiplier: 4.0, condition: '10+ Turns', color: 'text-gray-500' }, // Simplified max
};
...
export const getBallMultiplier = (ballKey: string, pokemonTypes: string[] = [], isNight: boolean = false, turn: number = 1): number => {
