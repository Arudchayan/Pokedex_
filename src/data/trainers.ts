...
export const TRAINERS: Trainer[] = [
  ...
  { id: 'erika', name: 'Erika', region: 'Kanto', class: 'Gym Leader', team: [71, 114, 45] }, // Victreebel, Tangela, Vileplume
  {
    ...
    region: 'Kanto',
    class: 'Gym Leader',
    team: [111, 112, 53, 34, 31],
  }, // Rhyhorn, Rhydon, Persian, Nidoking, Nidoqueen
  {
    id: 'blue',
    name: 'Blue',
    region: 'Kanto',
    class: 'Champion',
    team: [18, 103, 65, 112, 130, 6],
  }, // Pidgeot, Exeggutor, Alakazam, Rhydon, Gyarados, Charizard (Mixed)
  ...
  // Hoenn
  {
    ...
    region: 'Hoenn',
    class: 'Champion',
    team: [227, 306, 344, 348, 297, 376],
  }, // Skarmory, Aggron, Claydol, Armaldo, Hariyama (Wait, metagross is 376)
  {
    id: 'cynthia',
    name: 'Cynthia',
    region: 'Sinnoh',
    class: 'Champion',
    team: [442, 448, 407, 468, 445, 449],
  }, // Spiritomb, Lucario, Roserade, Togekiss, Garchomp, Milotic (Garchomp is 445)
  ...
  // Kalos
  {
    ...
    region: 'Kalos',
    class: 'Champion',
    team: [701, 699, 697, 706, 715, 282],
  }, // Hawlucha, Aurorus, Tyrantrum, Goodra, Gourgeist, Gardevoir
  ...
  // Galar
  {
    ...
    region: 'Galar',
    class: 'Champion',
    team: [681, 778, 612, 534, 815, 6],
  }, // Aegislash, Dragapult, Haxorus, Seismitoad, Cinderace/Rillaboom/Inteleon... let's say Charizard logic.
];
